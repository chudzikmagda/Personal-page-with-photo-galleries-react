...
export const SOCIAL_MEDIA: SocialMedia[] = [
  {
    ...
    path: 'https://www.instagram.com/chudzikmagda',
  },
  {
    icon: FacebookIcon,
    name: SocialMediaNames.FACEBOOK,
    path: 'https://www.facebook.com/chudzikmagda',
  },
  {
    icon: BehanceIcon,
    name: SocialMediaNames.BEHANCE,
    path: 'https://www.behance.net/magdachudzik',
  },
  {
    icon: LinkedinIcon,
    name: SocialMediaNames.LINKEDIN,
    path: 'https://www.linkedin.com/in/chudzikmagda',
  },
];
