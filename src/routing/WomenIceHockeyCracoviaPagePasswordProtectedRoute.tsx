...
import { PasswordProtectedRouteProps } from './types/routing.types';
...
const WomensIceHockeyCracoviaPagePasswordProtectedRoute: React.FC<PasswordProtectedRouteProps> = ({ children }) => {
	...
	const ACCESS_PASSWORD = import.meta.env.VITE_WOMENS_ICE_HOCKEY_CRACOVIA_PASSWORD as string | undefined;
